...
<html>
    <head>
        ...
        <title><%=p.getpTitle()%>|| TechBlog by Eknoor</title>
        <!--css-->
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v8.0" nonce="MNky8w5K"></script>
</head>
<body>
    <!--start of navbar-->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="profile.jsp"><span class="fa fa-bell-o"></span>LearnCode with Eknoor<span class="sr-only">(current)</span></a>
                </li>
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-center bg-primary primary-background">
                        ...
                        <div class="card-footer">
                            <div class="fb-comments" data-href="http://localhost:9413/TechBlog/show_blog_page.jsp?post_id=<%=p.getPid() %>" data-numposts="5" data-width=""></div>
                        </div>
                </div>
            </div>
        </div>
